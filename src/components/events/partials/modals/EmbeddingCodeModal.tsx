	...
	return (
		<>
			...
			<div className="embedded-code-boxes">
				<ButtonLikeAnchor
					id="620x349"
					extraClassName="embedSizeButton size_620x349 button-like-anchor"
				...
				<ButtonLikeAnchor
					id="540x304"
					extraClassName="embedSizeButton size_540x304 button-like-anchor"
					onClick={(e) => updateTextArea(e)}
				>
				...
				<ButtonLikeAnchor
					id="460x259"
					extraClassName="embedSizeButton size_460x259 button-like-anchor"
					onClick={(e) => updateTextArea(e)}
				>
				...
				<ButtonLikeAnchor
					id="380x214"
					extraClassName="embedSizeButton size_380x214 button-like-anchor"
					onClick={(e) => updateTextArea(e)}
				>
